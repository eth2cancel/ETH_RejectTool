package com.eth2cancel.rejecttool.ui;
...
public class UiFrame {
	...
	public static JFrame placeComponents() {
		// 创建 JFrame 实例
		JFrame frame = new JFrame("ETH Reject Tool By eth2cancel.com");
		...
		JLabel linklabel = new JLabel("<html><a href='https://www.eth2cancel.com'> eth2cancel.com </a></html>");  
		linklabel.setBounds(10, 200, 500, 25);
        linklabel.addMouseListener(new MouseAdapter() {  
            public void mouseClicked(MouseEvent e) {  
                try {  
                    Runtime.getRuntime().exec("cmd.exe /c start " + "https://www.eth2cancel.com");  
                } catch (Exception ex) {  
                    ex.printStackTrace();  
                }  
            }  
        ...
        JLabel gitlabel = new JLabel("<html><a href='https://github.com/eth2cancel/ETH_RejectTool'> GitHub </a></html>");  
		gitlabel.setBounds(600, 200, 500, 25);
        gitlabel.addMouseListener(new MouseAdapter() {  
            public void mouseClicked(MouseEvent e) {  
                try {  
                    Runtime.getRuntime().exec("cmd.exe /c start " + "https://github.com/eth2cancel/ETH_RejectTool");  
                } catch (Exception ex) {  
                    ex.printStackTrace();  
                }  
            }  
